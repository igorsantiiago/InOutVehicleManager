...
public class HandlerTest
{
    ...
    private readonly Requests.CreateRequests requests;
    ...
    [Fact]
    public async void Should_Fail_When_Type_Is_Not_Exists() 
    {
    ...
    [Fact]
    public async void Should_Fail_When_LicensePlate_Already_Exists() 
    {
        var result = await _handler.Handle(requests.invalidLicensePlateAlreadyExists, new CancellationToken());
        Assert.False(result.IsSuccess);
    }
    #endregion
