...
public class FakeRepository : IRepository
{
    ...
    private readonly Employee? _emailExists = new("Douglas", "Adams", "01234567890", "emailexists@contato.com", null);
    private readonly Employee? _employee = new("Douglas", "Adams", "01234567890", "contato@contato.com", null);
