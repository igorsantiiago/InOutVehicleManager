using InOutVehicleManager.Core.Contexts.EmployeeContext.UseCases.RemoveRole;
using InOutVehicleManager.Core.Contexts.EmployeeContext.UseCases.RemoveRole.Contracts;

namespace InOutVehicleManager.Tests.Contexts.EmployeeContext.UseCases.RemoveRole;

public class HandlerTest
{
    private readonly IRepository _repository;
    private readonly Handler _handler;
    private readonly Requests.RemoveRole _requests;
