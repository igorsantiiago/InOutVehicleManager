using InOutVehicleManager.Core.Contexts.CompanyContext.UseCases.ParkingUseCases.UpdateParking;
...
public class HandlerTests
{
    ...
    private readonly Requests.UpdateParking _requests;
    ...
    [Fact]
    public async void Should_Succeed_When_Update_Parking()
    {
        var response = await _handler.Handle(_requests.validParkingUpdate, new CancellationToken());
