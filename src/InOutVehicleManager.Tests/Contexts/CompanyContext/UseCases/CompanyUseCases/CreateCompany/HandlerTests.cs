...
public class HandlerTests
{
    ...
    private readonly Requests.CreateCompany _requests;
    ...
    [Fact]
    public async void Should_Fail_When_Company_Already_Exists()
    {
        var response = await _handler.Handle(_requests.invalidCompanyAlreadyExists, new CancellationToken());
        Assert.False(response.IsSuccess);
    }
    #endregion
    ...
    [Fact]
    public async void Should_Succeed_When_Create_Company()
    {
